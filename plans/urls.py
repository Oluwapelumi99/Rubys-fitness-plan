...
urlpatterns = [
    ...
    path(
        'edit_glutes/<int:glutes_exercise_id>/',
        views.edit_glutes_exercise, name='edit_glutes_exercise'),
    path(
    ...
    path(
        'edit_abs<int:abs_exercise_id>/',
        views.edit_abs_exercise, name='edit_abs_exercise'),
    path(
